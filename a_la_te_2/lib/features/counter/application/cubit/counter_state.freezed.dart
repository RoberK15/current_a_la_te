...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CounterState&&(identical(other.counterValue, counterValue) || other.counterValue == counterValue));
}
...
/// Create a copy of CounterState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? counterValue = null,}) {
  return _then(_self.copyWith(
counterValue: null == counterValue ? _self.counterValue : counterValue // ignore: cast_nullable_to_non_nullable
as int,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int counterValue)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CounterState() when $default != null:
return $default(_that.counterValue);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int counterValue)  $default,) {final _that = this;
switch (_that) {
case _CounterState():
return $default(_that.counterValue);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int counterValue)?  $default,) {final _that = this;
switch (_that) {
case _CounterState() when $default != null:
return $default(_that.counterValue);case _:
  return null;
...
class _CounterState implements CounterState {
  const _CounterState({this.counterValue = 0});
  

@override@JsonKey() final  int counterValue;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CounterState&&(identical(other.counterValue, counterValue) || other.counterValue == counterValue));
}
...
/// Create a copy of CounterState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? counterValue = null,}) {
